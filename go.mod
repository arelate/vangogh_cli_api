...
require (
	github.com/arelate/gog_auth v0.1.4
	...
	github.com/arelate/vangogh_urls v0.1.12
	github.com/arelate/vangogh_values v0.1.5
	github.com/boggydigital/coost v0.3.4
...
require (
	...
	github.com/boggydigital/wits v0.1.1 // indirect
